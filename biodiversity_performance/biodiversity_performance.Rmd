...
![Screenshot of biodiversity](screenshot.png) : [(demo)](https://kmezhoud.shinyapps.io/biodiversity/)
...
I can site a wrapper of zxing JS library to shinyApp. The goal is to read barcode using smartphone/laptop camera [link](https://github.com/kmezhoud/shinyQuaggaJS/tree/zxing-js). [demo](https://kmezhoud.shinyapps.io/shinyXZing/_w_8de908dc/)
