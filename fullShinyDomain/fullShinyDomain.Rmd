...
# Dockerize a shinyProxy with multiple Login/Shiny App
...
For more secure login process, I will use [Auth0](https://auth0.com/) web service. ShinyProxy supports authentication and authorization using an IDP (Identity Provider) conforming to the [SAML 2.0](https://www.shinyproxy.io/documentation/configuration/#saml-20) specification.
...
* Create a new data base to store users login specifications
...
* Comeback to settings tab and go to Application URIs section. Paste login URI and set localhost in URLs.
...
* Browse to https://www.fullshinydomain.ml 
