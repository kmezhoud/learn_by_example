...
def plot_hw_air_id(air_id):
    ...
    plt.plot(visits_train['visit_date'], 
              visits_train['visitors'], label='Training Data')
              
    plt.plot(visits_valid['visit_date'], 
             visits_valid['visitors'], 
             label='Validation Data', color='grey')
             
    plt.plot(visits_valid['visit_date'], hw_forecast, 
             label='Holt-Winters Forecast', color='blue')
    
#    plt.plot(visits_valid['visit_date'], hw_visits, 
#             label='Holt-Winters Forecast', color='red')
             
    #plt.fill_between(visits_valid['visit_date'],
    #                  hw_forecast - hw_fit.bse,
    #                  hw_forecast + hw_fit.bse, 
    #                  color='lightblue')
    
    plt.xlabel('Time [weeks]')
    plt.ylabel('log1p visitors vs predictions')
