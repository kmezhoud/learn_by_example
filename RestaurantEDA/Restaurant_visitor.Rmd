...
sns.regplot(x='reserve_visitors', y='visitors', 
...
p3_ax.set_xlabel('Prefecture', fontsize= 8)
...
foo = merged_df.groupby(['air_store_id', 'air_genre_name'],observed=True).agg(mean_log_visits=('visitors',
...
# p= plot_auto_arima_air_id(air_id = "air_f3f9824b7d70c3cf",
#                         ax = fig.add_subplot(gs[0, 0]))
# 
# p= plot_auto_arima_air_id(air_id = "air_8e4360a64dbd4c50",
...
#Add plots to the grid
p= plot_hw_air_id(air_id = "air_820d1919cbecaa0a", 
                        ax = fig.add_subplot(gs[0]))

p= plot_hw_air_id(air_id = "air_8e4360a64dbd4c50",
                         ax= fig.add_subplot(gs[1]))
                         
p= plot_hw_air_id(air_id = "air_f3f9824b7d70c3cf",
                         ax= fig.add_subplot(gs[2]))

p= plot_hw_air_id(air_id = "air_1c0b150f9e696a5f",
...
# Assuming 'y' is the dependent variable and 'X' contains the independent variables
## non numeric column
# visits_train_aug[['air_store_id', 'wday', 'month', 'ds_quarteryear', 'ds_month_lbl', ' ds_wday_lbl', 'ds_am_pm']]
X = visits_train_aug.select_dtypes(['number'])
X = X.drop(columns=['visitors', 'ds_index_num']) #, , 'ds_year', 'ds_year_iso'
X = X.astype('int')
...
def plot_tk_lm_air_id(air_id, ax):
  ...
  #                    color='lightblue')
    ...
    ax.set_title('timetk for air_'+ str(air_id))
    plt.legend()
    return(ax)
...
::: {}
```{r}
weather_stations <- as.tibble(fread(str_c("data/weather_stations.csv")))
...
weather_stations = weather_stations[weather_stations['date_terminated'] != ""]
...
foobar = weather_stations[weather_stations['date_terminated'] != ""]
...
# Plotting joyplot for maximum temperature and average humidity side by side
...
p1= axes[0].set_title('Joyplot of Maximum Temperature by Month')
...
p2= axes[1].set_title('Joyplot of Average Humidity by Month')
