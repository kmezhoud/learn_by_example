...
visits_train_aug = augment_timeseries_signature(data= visits_train, date_column = 'ds')
...
def plot_tk_lm_air_id(air_id, ax):
    ...
    # Generate a sequence of dates
    all_visits = pd.DataFrame({'visit_date': pd.date_range(start=air_visits['visit_date'].min(),
    end=max_date)})
