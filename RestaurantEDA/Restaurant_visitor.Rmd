...
m = folium.Map(location=[air_store['latitude'].mean(),
               air_store['longitude'].mean()],
...
p1= p1.set_xticklabels(custom_wday_order)  
p1= p1.legend('')
...
p3= p3.set_xticklabels(custom_month_order, rotation=45)  
p3= p3.legend('')
...
X = X.drop(columns=['visitors', 'ds_index_num', 'log1p_visitors']) #, , 'ds_year', 'ds_year_iso'
X = X.astype('int')
...
p1= p1.set_title('Joyplot of Maximum Temperature by Month')
...
p2= p2.set_title('Joyplot of Average Humidity by Month')
...
p2.set_title('Joyplot of Average Humidity by Month')
